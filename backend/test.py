...
import asyncio
import vertexai
from vertexai.preview.generative_models import GenerativeModel, Tool, RetrievalTool
from vertexai.preview.generative_models import RetrievalTool
...
vertexai.init(project="octopus-449307", location="us-central1")
